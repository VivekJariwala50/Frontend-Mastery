...
export const AKClipBoard = ({ AKClipBoardCardClassName }) => {
  ...
  return (
    <>
      <div className={AKClsx(AKClipBoardCardClassName, "flex gap-5 flex-wrap")}>
        ...
        <div>
          <CopyToClipboard text={textToCopy} onCopy={onCopyText}>
            <Button className={AKClsx(styles.AKClipBoardBtn)}>
              Copy to Clipboard
            </Button>
          </CopyToClipboard>
        </div>
