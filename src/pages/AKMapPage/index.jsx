...
import styles from "./AKMapPage.module.css";
...
const AKMapPage = () => {
  return (
    <>
      <AKHead title="Map" />
      <h1 className="mb-5 title-color">Map Page</h1>
      ...
      >
        <Col xs={24} xl={12}>
          ...
          >
            <div className={AKClsx(styles.mapCard)}>
              <iframe
        ...
        <Col xs={24} xl={12}>
          ...
          >
            <div className={AKClsx(styles.mapCard)}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!3m2!1sen!2sin!4v1712656133489!5m2!1sen!2sin!6m8!1m7!1s_f05yyfaKyFd5ZrRNmre3w!2m2!1d41.85415146259668!2d12.19259932080484!3f256.05658!4f0!5f0.7820865974627469"
                width={"100%"}
                height={"100%"}
                style={{ border: 0 }}
                allowfullscreen=""
